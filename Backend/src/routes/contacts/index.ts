...
export default function () {
	...
	router.post(
		...
		body('tel.mobile')
			.optional()
			.isArray()
			.withMessage('Mobile phone numbers must be an array of numbers'),
		body('tel.work')
			.optional()
			.isArray()
			.withMessage('Work phone numbers must be an array of numbers'),
		body('tel.home')
			.optional()
			.isArray()
			.withMessage('Home phone numbers must be an array of numbers'),

		body('address').optional(),
		body('notes').optional().isArray(),
		body('notes.*.title').optional().isString().trim().notEmpty().bail(),
		body('notes.*.text').optional().isString().trim().notEmpty().bail(),
		body([
			'address.street',
			'address.city',
			'address.state',
